from {{cookiecutter.project_name}}.processors import HealthCheckProcessor
from {{cookiecutter.project_name}}.protobuf.healthcheck import healthcheck_pb2, healthcheck_pb2_grpc
